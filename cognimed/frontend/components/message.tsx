    ...
    return (
        <div className={`flex h-auto ${position} w-full`} >
            <div className={`flex ${align} `}>
                <div className='h-full flex justify-end items-end px-2'>     {((pathnameMiddle == 'research' && sender !== "me") ? <div className="w-8  h-8 rounded-full bg-[#c7c7c7]" > <svg className="w-8 h-8 rotate-animation duration-200" viewBox="-3.2 -3.2 38.40 38.40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  fill="#a936d3" stroke="#a936d3">
...
</svg></div>: (<div className=" my-4 relative w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
